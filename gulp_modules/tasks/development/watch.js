...
module.exports = function (options){
    return function(callback){
        if (options.styles != undefined) {
            gulp.watch(options.styles.watch, plugins.gulp.series(options.styles.task)).on('unlink', function(filepath){
        ...
        if (options.templates != undefined) {
            gulp.watch(options.templates.watch, gulp.series(options.templates.task)).on('unlink', function(filepath){
